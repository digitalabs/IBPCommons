...
public class CsvExportSampleListServiceImpl implements CsvExportSampleListService {
	...
	protected List<Map<Integer, ExportColumnValue>> getExportColumnValues(final List<ExportColumnHeader> columnHeaders,
	...
	private ExportColumnValue getColumnValue(final SampleDetailsDTO sampleDetailsDTO, final ExportColumnHeader column) {
		...
		switch (column.getName()) {
			...
			case TAKEN_BY:
				...
				break;
			case SAMPLING_DATE:
				columnValue = this.setSampleDateVale(column.getId(), sampleDetailsDTO.getSampleDate());
				break;
			case SAMPLE_UID:
			...
			case PLANT_UID:
				...
				break;
			case OBS_UNIT_ID:
				columnValue = new ExportColumnValue(column.getId(), sampleDetailsDTO.getObsUnitId());
				break;
			case GID:
