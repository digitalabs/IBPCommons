...
public class CrossNameServiceImpl implements CrossNameService {
	 ...
	 */
	@Override public String getNextNameInSequence(CrossNameSetting setting) throws MiddlewareQueryException{
	 ...
	 * @throws MiddlewareQueryException
	 */
	@Override public Integer getNextNumberInSequence(CrossNameSetting setting) throws MiddlewareQueryException{
		this.setting = setting;
    ...
    @Override public String buildNextNameInSequence(Integer number) {
