...
public enum ColumnLabels {
	...
	AVAILABLE_INVENTORY(TermId.AVAILABLE_INVENTORY, "LOTS"), BREEDING_METHOD_NAME(TermId.BREEDING_METHOD_NAME, "METHOD NAME"), BREEDING_METHOD_ABBREVIATION(
			...
			"PREFERRED NAME"), SEED_RESERVATION(TermId.SEED_RESERVATION, "WITHDRAWAL"), SEED_SOURCE(TermId.SEED_SOURCE, "SEED SOURCE"), STOCKID(
	        ...
	        MALE_NURSERY_NAME(TermId.MALE_NURSERY,"MALE NURSERY"), STATUS(TermId.STATUS, "STATUS"),
