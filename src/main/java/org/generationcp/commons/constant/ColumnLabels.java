...
public enum ColumnLabels {
	...
	AVAILABLE_INVENTORY(TermId.AVAILABLE_INVENTORY, "LOTS AVAILABLE"), BREEDING_METHOD_NAME(TermId.BREEDING_METHOD_NAME, "METHOD NAME"), BREEDING_METHOD_ABBREVIATION(
	...
	, AMOUNT(TermId.AMOUNT_INVENTORY, "AMOUNT"), BULK_WITH(TermId.BULK_WITH, "BULK WITH"), BULK_COMPL(TermId.BULK_COMPL, "BULK COMPL?"), COMMENT(
			...
			TermId.RESERVED_INVENTORY, "RES"), SCALE(TermId.SCALE_INVENTORY, "SCALE"), TOTAL(TermId.TOTAL_INVENTORY, "TOTAL"), UNITS(
