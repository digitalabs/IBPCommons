...
public abstract class HttpRequestAwareUtil {
    ...
    public static void onRequestStart(ApplicationContext applicationContext
            , HttpServletRequest request, HttpServletResponse response) {
        // notify all HttpRequestAware beans that an HTTP request has been started
        Map<String, HttpRequestAware> beans = 
                applicationContext.getBeansOfType(HttpRequestAware.class, false, false);
    ...
    public static void onRequestEnd(ApplicationContext applicationContext
            , HttpServletRequest request, HttpServletResponse response) {
