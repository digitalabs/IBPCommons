...
public interface ManagerFactoryProvider {
	 ...
	 * 
	 * When done using the ManagerFactory, call {@link ManagerFactoryProvider#closeManagerFactory(ManagerFactory)} to close the database
	 * connections used by the {@link ManagerFactory}.
	 * 
