...
/**
 * An interface for objects that wants to be notified when a request is started/ended.
 *
...
public interface HttpRequestAware {
	...
	/**
	 * Implement this method to perform actions needed when a request has started.
	 * 
	 * @param request
	 * @param response
	 */
