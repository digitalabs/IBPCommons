 ...
 *
 * This is based on Nicolas Frankel's implementation, which can be found here: http://blog.frankel.ch/vaadin-spring-integration
 *
...
public class SpringApplicationServlet extends AbstractApplicationServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		//bean definition is added in workbench's applicationcontext.xml
		if (name == null && "MainApplicationGPSB".equalsIgnoreCase(config.getServletName())) {
			name = "application_gpsb";
		} else if(name == null && "MainApplicationBM".equalsIgnoreCase(config.getServletName())){
			name = "application_bm";
		}
	...
	protected Application getNewApplication(HttpServletRequest request) throws ServletException {
		...
		Object bean = wac.getBean(this.name);
		if (!(bean instanceof Application)) {
			throw new ServletException("Bean " + this.name + " is not an instance of " + Application.class);
		}
	...
	protected Class<? extends Application> getApplicationClass() throws ClassNotFoundException {
		...
		Object bean = wac.getBean(this.name);
		if (bean == null) {
			throw new ClassNotFoundException("No application bean found under name " + this.name);
		}
