...
public class GermplasmAttributesWorkbookExporterTest {
	...
	public void testGetSourceItems() {
		try (final MockedStatic<ContextHolder> contextHolderMockedStatic = Mockito.mockStatic(ContextHolder.class)) {
			contextHolderMockedStatic.when(() -> ContextHolder.getCurrentProgram())
				.thenReturn(null);
