...
public class GermplasmNamingServiceImplTest {
	...
	public void testGetNextSequence() {
		...
		Mockito.verify(this.germplasmDataManager, Mockito.never()).getNextSequenceNumberString(ArgumentMatchers.anyString());
	}
	...
	public void testGetNextSequenceFromNames() {
		...
		Mockito.doReturn(String.valueOf(nextNumberFromNames)).when(this.germplasmDataManager).getNextSequenceNumberString(PREFIX);
