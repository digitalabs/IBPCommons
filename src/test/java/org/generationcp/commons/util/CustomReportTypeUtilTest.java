...
public class CustomReportTypeUtilTest {
	...
	public void testReadReportConfiguration(){
		...
		standardPreset.setConfiguration("<?xml version=\"1.0\"?><reports><report><code>WLBL05</code><name>labels without design, wheat</name></report><report><code>WLBL21</code><name>labels with design, wheat</name></report></reports>");
		List<CustomReportType> customReportTypes = CustomReportTypeUtil.readReportConfiguration(standardPreset);
